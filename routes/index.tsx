    ...
    sections: [
      {
        ...
        skills: ["Go", "Javascript", "Kotlin", "Java", "PHP"],
      },
      {
    ...
    jobs: [
      {
        ...
        date: "Septiembre 2017 - Julio 2025, México.",
        tasks: [
          "Desarrollador Front y Backend del Sistema de Monitoreo SCADA usando React.js, Golang y Docker.",
          "Desarrollador de servicios, herramientas para la gestión del sistema, Aplicaciones e interfaces para unidades embebidas, dispositivos de adquisición de datos usando Golang.",
          ...
          "Desarrollador Backend del sistema Web de Monitoreo SCADA de Django a Golang usando el framework Echo.",
    ...
    items: [
      {
        ...
        links: [
          {
            text: "Ver más ...",
            url: "https://technotex.com/servicios/desarrollo-de-software-para-telemetria-y-automatizacion",
          },
        ],
        images: [],
        videos: [],
